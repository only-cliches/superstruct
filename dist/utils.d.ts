 ...
 */
export type StructSchema<T> = [T] extends [string | undefined | null] ? [T] extends [IsMatch<T, string | undefined | null>] ? any : [T] extends [IsUnion<T>] ? EnumSchema<T> : T : [T] extends [number | undefined | null] ? [T] extends [IsMatch<T, number | undefined | null>] ? null : [T] extends [IsUnion<T>] ? EnumSchema<T> : T : [T] extends [boolean] ? [T] extends [IsExactMatch<T, boolean>] ? null : T : T extends Map<infer K, infer V> ? [Struct<K>, Struct<V>] : T extends Set<infer V> ? Struct<V> : T extends bigint | symbol | undefined | null | Function | Date | Error | RegExp | WeakMap<any, any> | WeakSet<any> | Promise<any> ? null : T extends Array<infer E> ? T extends IsTuple<T> ? any : Struct<E> : T extends object ? T extends IsRecord<T> ? [any, any] : {
