...
export declare function instance<T extends {
    new (...args: any): any;
}>(Class: T): Struct<InstanceType<T>, T>;
/**
 ...
 */
export declare function intersection<A extends AnyStruct, B extends AnyStruct[]>(Structs: [A, ...B]): Struct<Infer<A> & UnionToIntersection<InferStructTuple<B>[number]>, [A, ...B]>;
/**
...
export declare function map<K, V>(Key: Struct<K>, Value: Struct<V>): Struct<Map<K, V>, [Struct<K>, Struct<V>]>;
/**
 ...
 */
export declare function record<K extends string, V>(Key: Struct<K>, Value: Struct<V>): Struct<Record<K, V>, [Struct<K>, Struct<V>]>;
/**
...
export declare function set<T>(Element: Struct<T>): Struct<Set<T>, Struct<T>>;
/**
 ...
 */
export declare function tuple<A extends AnyStruct, B extends AnyStruct[]>(Structs: [A, ...B]): Struct<[Infer<A>, ...InferStructTuple<B>], [A, ...B]>;
/**
 ...
 */
export declare function union<A extends AnyStruct, B extends AnyStruct[]>(Structs: [A, ...B]): Struct<Infer<A> | InferStructTuple<B>[number], [A, ...B]>;
/**
